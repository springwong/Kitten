...
public class SampleActivity extends AppCompatActivity {
    ...
    @BindContext @DecoBackground(android.R.color.holo_red_dark)
    TextView textViewA;
    @BindContext @DecoBackground(android.R.color.holo_green_light)
    TextView textViewB;
...
//        textViewC.setTextAppearance(R.style.textStyleExample);
        ...
        Kitten.create(KittenOrientation.vertical)
                ...
                .add(textViewB)
                .add(textViewC)
                .add(fillParentExample()).align(KittenAlignment.parent)
                .add(child)
                .add(alignLeftItems())
                .build();
...
//                .add(textView1)
    ...
    private View weightExample(){
        ...
        return Kitten.create(KittenOrientation.horizontal).from(this)
    ...
    private View fillParentExample(){
        TextView viewA = new TextView(this);
        TextView viewB = new TextView(this);
        TextView viewC = new TextView(this);
        viewA.setText("1233r 23r gergre");
        viewB.setText("123");
        viewC.setText("View C");
        viewA.setBackgroundColor(getResources().getColor(android.R.color.holo_blue_dark));
        viewB.setBackgroundColor(getResources().getColor(android.R.color.holo_green_dark));
        viewC.setBackgroundColor(getResources().getColor(android.R.color.holo_red_dark));
        return Kitten.create(KittenOrientation.horizontal).from(this).isAlignDirectionEnd(false)
                .add(viewA)
                .add(viewB).fillParent()
                .add(viewC)
                .build();
    }
}
